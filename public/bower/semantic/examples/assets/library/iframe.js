...
;(function() {
  ...
  function getMyID(){
    var retStr = 'Host pages';

    if (window.top!==window.self){
      if (window.parentIFrame){
        retStr = window.parentIFrame.getId();
      } else {
        retStr = 'Nested host pages';
      }
    }
  ...
  function iFrameListener(event){
    ...
    function isMessageFromMetaParent(){
      ...
      if (retCode){
        log(' Ignoring init message from meta parent pages');
      }
    ...
    function findTarget(location){
      ...
      if(window.top!==window.self){
        if (window.parentIFrame){
          ...
          log(' In pages link #'+hash+' not found and window.parentIFrame not found');
        }
      } else if (target){
        jumpToTarget(target);
      } else {
        log(' In pages link #'+hash+' not found');
      }
    }
  ...
  function getPagePosition (){
    if(null === pagePosition){
      ...
      log(' Get pages position: '+pagePosition.x+','+pagePosition.y);
    }
  }
  ...
  function setPagePosition(){
    if(null !== pagePosition){
      ...
      log(' Set pages position: '+pagePosition.x+','+pagePosition.y);
      pagePosition = null;
    }
  }
  ...
  function resetIFrame(messageData){
    ...
    log(' Size reset requested by '+('init'===messageData.type?'host pages':'iFrame'));
    getPagePosition();
  ...
  function setupIFrame(options){
    ...
    function init(msg){
      ...
      //event listener also catches the pages changing in the iFrame.
